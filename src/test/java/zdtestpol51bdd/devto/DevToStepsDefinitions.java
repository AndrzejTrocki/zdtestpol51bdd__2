...
public class DevToStepsDefinitions {
    ...
    @Then("Top {int} blogs found should have correct phrase in title or snipped")
    public void top_blogs_found_should_have_correct_phrase_in_title_or_snipped(Integer int1){
